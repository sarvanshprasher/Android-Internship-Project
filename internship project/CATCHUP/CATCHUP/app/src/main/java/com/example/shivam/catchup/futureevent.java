...
public class futureevent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_futureevent);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new tripdatefragment(), "TRIP DATE");
        adapter.addFragment(new tripinfoFragment(), "TRIP INFORMATION");
